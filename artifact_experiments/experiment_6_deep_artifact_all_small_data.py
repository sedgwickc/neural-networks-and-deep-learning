...
data_artifact_exp = "../data/mnist_artifact_25_25.pkl.gz"
mini_batch_size = 10

print("Running deep learning network experiments with all artifact data...")
...
plt.savefig("results/ensemble_errors_artifact_all_small_data.png")
# plot the filters learned by the first of the nets just trained
plt = conv.plot_filters(nets_all[0], 0, 5, 4)
plt.savefig("results/net_full_layer_0_artifact_all_small_data.png")
plt = conv.plot_filters(nets_all[0], 1, 8, 5)
plt.savefig("results/net_full_layer_1_artifact_all_small_data.png")
