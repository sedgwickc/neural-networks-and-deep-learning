...
plt.savefig("results/ensemble_errors_artifact_all.png")
# plot the filters learned by the first of the nets just trained
plt = conv.plot_filters(nets_all[0], 0, 5, 4)
plt.savefig("results/net_full_layer_0_artifact_all.png")
plt = conv.plot_filters(nets_all[0], 1, 8, 5)
plt.savefig("results/net_full_layer_1_artifact_all.png")
